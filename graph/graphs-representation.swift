...
class Graph {
    ...
    func getEdgeList() -> [[Int]] {
        var edgeList = [[Int]]()
        edges.forEach { edgeList.append([$0.value!, $0.nodeFrom!.value!, $0.nodeTo!.value!]) }
        return edgeList
    }
    ...
    func getAdjacencyList() -> [[[Int]]] {
        ...
        for edge in edges {
            adjacencyList[edge.nodeFrom!.value!].append([edge.nodeTo!.value!, edge.value!])
        }
